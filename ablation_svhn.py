...
accu1 = np.append(svhn_line,np.load('accuracy_svhn_line_1d0.npy'))
accu2 = np.append(svhn_line,np.load('accuracy_svhn_line_1d1.npy'))
accu3 = np.append(svhn_line,np.load('accuracy_svhn_line_1d2.npy'))
accu4 = np.append(svhn_line,np.load('accuracy_svhn_line_1d3.npy'))
...
test1 = np.append(svhn_line1,np.load('test_loss_svhn_line_1d0.npy'))
test2 = np.append(svhn_line1,np.load('test_loss_svhn_line_1d1.npy'))
test3 = np.append(svhn_line1,np.load('test_loss_svhn_line_1d2.npy'))
test4 = np.append(svhn_line1,np.load('test_loss_svhn_line_1d3.npy'))
...
train1 = np.append(svhn_line1,np.load('train_loss_svhn_line_1d0.npy'))
train2 = np.append(svhn_line1,np.load('train_loss_svhn_line_1d1.npy'))
train3 = np.append(svhn_line1,np.load('train_loss_svhn_line_1d2.npy'))
train4 = np.append(svhn_line1,np.load('train_loss_svhn_line_1d3.npy'))
