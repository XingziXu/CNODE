...
def main():
    ...
    with open('train_loss_cifar_high_2d3.npy', 'wb') as f:
        np.save(f, np.asarray(loss_train))
    with open('test_loss_cifar_high_2d3.npy', 'wb') as f:
        np.save(f, np.asarray(loss_test))
    with open('accuracy_cifar_high_2d3.npy', 'wb') as f:
