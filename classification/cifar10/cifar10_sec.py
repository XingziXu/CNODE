...
class Grad_net(nn.Module): # the Grad_net defines the networks for the path and for the gradients
    def __init__(self, width_grad: int, width_conv1: int, width_conv2: int, width_aug: int):
        super().__init__()
...
def main():
    ...
    grad_net = Grad_net(width_grad=args.width_grad, width_conv1=args.width_conv1, width_conv2=args.width_conv2, width_aug=args.width_aug).to(device) # define grad_net and assign to device
