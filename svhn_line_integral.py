...
def main():
    ...
    dataset1 = datasets.SVHN('../data', download=True,
                       transform=transform)

    dataset1, dataset2, dataset3 = torch.utils.data.random_split(dataset1, [53257,10000, 10000]) # dataset 1 is training, dataset 2 is testing, dataset 3 is validation
